...
eodyisusdenazar41
```shell
docker run --rm -it -p 5080:5080 -p 6080:6080 -p 8080:8080 -p 9080:9080 --name dgraph dgraph/standalone:latest
```
...
```shell
docker run --rm --name ratel  -d -p "8000:8000" dgraph/ratel:latest
```
